function [classes, perf_HMM] = buildTrainTestNNAndHMM_cellArrayInputs(trainNN_data, trainNN_segments, trainHMM_data, trainHMM_segments, test_data, test_segments, hidden_layers, step_size, window_size, trainFcn)
...
function [classes, perf_HMM] = testNNAndHMM(net, TRANS, EMIS, test_data, test_segments, step_size, window_size)
    ...
    plotClasses(test_data, classes);
    plotGroundTruth(test_data, test_segments);
end
